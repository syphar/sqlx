...
pub struct LogSettings {
    ...
    pub statements_trace_level: LevelFilter,
...
impl Default for LogSettings {
    fn default() -> Self {
        LogSettings {
            ...
            statements_trace_level: LevelFilter::Info,
...
impl LogSettings {
    ...
    pub fn trace_statements(&mut self, level: LevelFilter) {
        self.statements_trace_level = level;
    }
